...
function Navbar(props)
{
  ...
  const [tabValue, setTabValue] = useState(tabsUrl[url] || 0);
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Tabs orientation="vertical"
          value={tabValue} onChange={handleChange} aria-label="navigation tabs">
          <Tab
            ...
            icon={
              <div
                ...
                <Tooltip title="Send Email"><SendIcon /></Tooltip>
              </div>}
            label="Send Email"
            to="/send"
            component={NavLink} />
